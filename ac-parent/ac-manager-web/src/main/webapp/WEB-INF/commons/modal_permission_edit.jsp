<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div id="permissionEditModal" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="permissionEditForm" role="form">
					...
					<button id="permissionEditSubmitBtn" type="button" class="btn btn-success">
						<i class="glyphicon glyphicon-pencil"></i> 更新
					</button>
					<button id="permissionEditResetBtn" type="reset" class="btn btn-danger">
